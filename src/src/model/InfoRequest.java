...
public class InfoRequest {
	...
	public InfoRequest(String itemSeq, String itemName, String entpName, String itemPermitDate,
	...
	public String toString() {
		return "InfoRequest [itemSeq=" + itemSeq + ", itemName=" + itemName + ", entpName=" + entpName
	...
	public void validate(Map<String, Boolean> errors) {
		if(itemName == null || itemName.trim().isEmpty()) {
			errors.put("itemName", Boolean.TRUE);
		}
	}
